...
txt_description=r"Ein Geocache für motorradfahrende Geocacher. Einfach zu finden, nur ranfahren, zugreifen, loggen und weiter. Anspruchsvolle Geocacher suchen sich besser ein anderes Ziel. Bitte eigenen Stift mitbringen!"
...
# hol die anschrift, besonders die strasse
...
print ("Adresse:",formatted_address)
...
browser.get(href)
browser.find_element_by_id("ctl00_ContentBody_ImageUploadControl1_uxFileUpload").send_keys(os.getcwd()+"\\"+file_path)
